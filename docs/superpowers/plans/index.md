...
**Implemented and committed (2026-09-15) — collaboration half.** Tasks 7, 8, 9, 26, 27, 10, 15, 16, 17, 18, 19, 20, 28, 22, 23, 24, 25, 29 and 30 are implemented and committed on `feat/menschen-im-system`; Task 21 is superseded. Commit range `7c935827`–`4b891f53` (24 commits), DoD PASS. Local test-gate status: **red, but not branch-attributable** — every observed red is green in isolation or deterministically environment-caused; see [`docs/se/reports/KNOWN_TEST_GATE_REDS.md`](../../se/reports/KNOWN_TEST_GATE_REDS.md) (KI-1 correction, F2, F3, F4).
