...
- Name: ontology-simulation.spec.ts >> Ontology Simulation & Trace Link Config >> simulate L1 to L2 decomposition with derives-from
- Location: tests\ontology-simulation.spec.ts:41:7
