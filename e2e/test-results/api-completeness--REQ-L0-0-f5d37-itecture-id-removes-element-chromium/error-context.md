...
- Name: api-completeness.spec.ts >> [REQ-L0-012] REST API Completeness >> [REQ-L0-012] DELETE /api/v1/architecture/{id}/ removes element
- Location: tests\api-completeness.spec.ts:160:7
