...
Direction per traceability.types.SE_LINK_SEMANTICS: a `verifies` link goes
TestCase (source) -> Requirement (target).
...
class TestGetVerifiedRequirements:
    ...
    def test_single_chain_returns_requirement(self, tenant, workspace):
        ...
        with active_tenant(tenant):
            ...
            make_trace_link(tc_art, req_art, tenant, "verifies")
    ...
    def test_multi_chain_dedupes_requirements(self, tenant, workspace):
        ...
        with active_tenant(tenant):
            ...
            make_trace_link(tc1_art, req_art, tenant, "verifies")
            make_trace_link(tc2_art, req_art, tenant, "verifies")
    ...
    def test_multi_chain_distinct_requirements(self, tenant, workspace):
        ...
        with active_tenant(tenant):
            ...
            make_trace_link(tc1_art, req1_art, tenant, "verifies")
            make_trace_link(tc2_art, req2_art, tenant, "verifies")
    ...
    def test_unlinked_test_case_excluded(self, tenant, workspace):
        ...
        with active_tenant(tenant):
            ...
            make_trace_link(linked_tc_art, req_art, tenant, "verifies")
