...
- Name: artifact-diff.spec.ts >> [COMP-RF-014] ArtifactDiff >> [REQ-L2-RF-014] diff view shows version 0 baseline as all fields added
- Location: tests\artifact-diff.spec.ts:75:7
