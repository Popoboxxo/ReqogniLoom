...
- Name: requirement-editor.spec.ts >> [COMP-RF-003] RequirementEditors >> [REQ-L2-RF-006] requirement editor shows tracelink panel with create button
- Location: tests\requirement-editor.spec.ts:74:7
