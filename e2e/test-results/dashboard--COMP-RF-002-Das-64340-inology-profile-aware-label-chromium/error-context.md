...
- Name: dashboard.spec.ts >> [COMP-RF-002] DashboardViews >> [REQ-L3-RF002-002] workspace cards render terminology-profile-aware label
...
Locator: locator('[data-testid="workspace-card"]').first()
Expected: visible
