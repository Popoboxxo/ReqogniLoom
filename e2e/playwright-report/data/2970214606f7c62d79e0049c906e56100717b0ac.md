...
- Name: architecture-editor.spec.ts >> [COMP-RF-004] ArchitectureEditors >> [REQ-L3-RF004-003] linked-requirements sidebar is rendered (empty state ok)
- Location: tests\architecture-editor.spec.ts:56:7
