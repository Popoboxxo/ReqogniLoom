 ...
 *          REQ-013   (Redesign: konsistente Sektions-/Tab-Struktur)
 *
 * REQ-013: the settings surface is organised into tabs. All settings groups
 ...
 * is a functional change and out of scope for the REQ-013 layout redesign.
 */
...
/** Tab identifiers for the settings surface (REQ-013). */
type SettingsTabId =
  | "general"
  | "traceability"
  | "visibility"
...
export default function WorkspaceSettings(): JSX.Element {
  ...
  // ---- Shared styles (REQ-013: single card/heading system) ----
